...
3. Insert http://165.227.50.143:8080/apis/ into the URL.
4. Click **SEND**
...
3. Insert http://165.227.50.143:8080/apis/tweet into the URL.
4. Click **SEND**
...
3. Insert http://165.227.50.143:8080/apis/sign-up into the URL & click send.
...
3. Check email in which you signed up for your site.
    ...
    2. Example: http://165.227.50.143:8080/apis/sign-up/activation/72c9238ebea318e69adfcbbc039b8e62
    3. Copy the link
...
4. Change the URL to your sign-in API
    1. Example: http://165.227.50.143:8080/apis/sign-in/
5. Click **JSON** tab.
...
4. Change the URL to your tweet API
    1. Example: http://165.227.50.143:8080/apis/tweet/
5. Click **JSON** tab.
...
8. Paste the id on the end of the url
    1. Example: http://165.227.50.143:8080/apis/tweet/tweetProfileId/8d236681-e31f-11ea-bff3-0242ac1b0003
9. Click **SEND**
